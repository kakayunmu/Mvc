...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class MvcRazorPagesMvcCoreBuilderExtensions
    {
        ...
        {
            if (!builder.PartManager.FeatureProviders.OfType<CompiledPageInfoFeatureProvider>().Any())
            {
                builder.PartManager.FeatureProviders.Add(new CompiledPageInfoFeatureProvider());
            }
        }
        ...
        internal static void AddServices(IServiceCollection services)
        {
            ...
            services.TryAddEnumerable(
                ServiceDescriptor.Singleton<IPageMetadataProvider, RazorProjectPageMetadataProvider>());
            services.TryAddEnumerable(
                ServiceDescriptor.Singleton<IPageMetadataProvider, CompiledPageMetadataProvider>());
            ...
            services.TryAddSingleton<CompiledPageMetadataProvider>();
        }
    }
}
